      ...
      <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-6 max-w-5xl">
        ...
        <header className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-0 mb-4 sm:mb-6">
            ...
            {/* Privacy badge - positioned absolutely in top right */}
            <div className="absolute top-4 right-4 sm:relative sm:top-auto sm:right-auto">
              ...
              {/* Privacy panel */}
              {showPrivacy && (
              <div className="absolute right-0 top-full mt-2 w-72 sm:w-80 bg-white rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6 z-50 animate-in slide-in-from-top-2 duration-200">
                <div className="flex items-start gap-4">
